...
class LMCacheEngine:
    ...
    def lookup(
        ...
        try:
            ...
            num_computed_tokens = (
                request_configs.get("num_computed_tokens", 0) if request_configs else 0
            )
            chunk_size = getattr(self.token_database, "chunk_size", 256)
            aligned_computed_tokens = (num_computed_tokens // chunk_size) * chunk_size

            if res > aligned_computed_tokens:
